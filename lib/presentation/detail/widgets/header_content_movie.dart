...
class HeaderContentMovie extends StatefulWidget {
  const HeaderContentMovie({super.key, required this.data});

  final Result data;

  @override
  State<HeaderContentMovie> createState() => _HeaderContentMovieState();
}

class _HeaderContentMovieState extends State<HeaderContentMovie> {
